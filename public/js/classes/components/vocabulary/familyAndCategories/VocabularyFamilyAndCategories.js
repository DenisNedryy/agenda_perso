...
export class VocabularyFamilyAndCategories{ 


    //  gauche page avec la famille, le avg % et les categories
        // pareil, à diviser en (title-header)/panneau-affichage/categories 
